...
SLIDE_NARRATIONS = {
    ...
    6: """We did extensive testing with real users. We surveyed 11 students from grades 6 through 12, and the results were incredible. 100% liked the extension. 100% found it easy to use. 100% liked the design. Average rating: 4.9 out of 5. Here's what they said: 'It was easy to understand the terms and conditions.' 'Very easy to understand the language.' And about the brainrot personality - 'it was funny' and 'everyone's on TikTok so it uses terms all ages can understand.' Bob was also a favorite - students loved the emojis and humor. What did we learn? Personality matters. Making legal docs fun and relatable works. Our 100% usability rate shows the design is intuitive for everyone from 6th to 12th grade. Users actually understood the terms after using our extension - proving our solution works. But we didn't just do user testing - we also tested for accuracy. We ran TikTok's entire Terms of Service through all five personas. The Lawyer persona scored 9 out of 10 on identifying scary parts. The CEO and Brain Rot personas both got 9 out of 10 on summaries. Bob got 9 out of 10 on pros and cons. After this testing, we refined our AI prompts to improve accuracy across all personas.""",
