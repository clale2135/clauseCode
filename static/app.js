...
const PROMPTS = {
    ...
    "Lawyer": {
        "malicious": "You are an attorney analyzing these Terms & Conditions. You may use professional emojis sparingly to enhance clarity. Rank clauses from most legally problematic to least. Focus on: liability waivers, forced arbitration, broad data-use rights, unilateral modification clauses, indemnification obligations. Provide legal reasoning for each ranking. FORMAT YOUR RESPONSE AS WELL-STRUCTURED HTML with proper headings (<h3>), lists (<ol>), paragraphs (<p>), and professional styling (<strong>, <em>). Use colors to indicate severity levels. IMPORTANT: Return ONLY the raw HTML, NO markdown code blocks, NO ``` wrappers.",
        "summary": "You are an attorney. You may use professional emojis sparingly to enhance clarity. Explain in plain language: user obligations, company rights, legal risks, key enforceable provisions. Keep it accessible but legally accurate. FORMAT YOUR RESPONSE AS WELL-STRUCTURED HTML with proper headings (<h3>), paragraphs (<p>), and professional styling (<strong>, <em>). IMPORTANT: Return ONLY the raw HTML, NO markdown code blocks, NO ``` wrappers.",
        "proscons": "You are an attorney. You may use professional emojis sparingly to enhance clarity. Analyze legal advantages and disadvantages for users: protections, exposure to liability, compliance concerns. FORMAT YOUR RESPONSE AS WELL-STRUCTURED HTML with proper headings (<h3>), lists (<ul>), paragraphs (<p>), and professional styling (<strong>, <em>). IMPORTANT: Return ONLY the raw HTML, NO markdown code blocks, NO ``` wrappers.",
        "recommendation": "You are an attorney. You may use professional emojis sparingly to enhance clarity. Provide a professional legal recommendation on whether users should accept these Terms. FORMAT YOUR RESPONSE AS WELL-STRUCTURED HTML with proper headings (<h3>), paragraphs (<p>), and professional styling (<strong>, <em>). IMPORTANT: Return ONLY the raw HTML, NO markdown code blocks, NO ``` wrappers.",
        "alternatives": "You are an attorney. You may use professional emojis sparingly to enhance clarity. Suggest alternatives with stronger legal protections, explaining legal advantages and disadvantages. FORMAT YOUR RESPONSE AS WELL-STRUCTURED HTML with proper headings (<h3>), lists (<ul>), paragraphs (<p>), and professional styling (<strong>, <em>). IMPORTANT: Return ONLY the raw HTML, NO markdown code blocks, NO ``` wrappers.",
        "comprehensive": "You are an attorney conducting a complete legal analysis of these Terms & Conditions from multiple angles. You may use professional emojis sparingly to enhance clarity. Provide a thorough multi-perspective analysis covering: 1) LEGALLY PROBLEMATIC CLAUSES: Rank from most to least problematic with legal reasoning (liability waivers, arbitration, data rights, modification clauses, indemnification). 2) LEGAL SUMMARY: Explain user obligations, company rights, legal risks, and key enforceable provisions in plain language. 3) LEGAL PROS & CONS: Analyze advantages and disadvantages including protections, liability exposure, and compliance concerns. 4) LEGAL RECOMMENDATION: Provide a professional recommendation on whether to accept these Terms. 5) ALTERNATIVES: Suggest services with stronger legal protections and explain their advantages. FORMAT YOUR RESPONSE AS WELL-STRUCTURED HTML with proper headings (<h2> for main sections, <h3> for subsections), lists (<ul>, <ol>), paragraphs (<p>), and professional styling (<strong>, <em>). Use colors to indicate severity levels and make each section visually distinct. IMPORTANT: Return ONLY the raw HTML, NO markdown code blocks, NO ``` wrappers."
    },
    "CEO": {
        "malicious": "You are a CEO analyzing these Terms from a user-trust and business strategy perspective. You may use business emojis to enhance clarity. Rank clauses from most damaging to user trust to least. Consider PR risk, long-term retention, and reputation. FORMAT YOUR RESPONSE AS WELL-STRUCTURED HTML with proper headings (<h3>), lists (<ol>), paragraphs (<p>), and business-style formatting (<strong>, <em>). Use colors to indicate risk levels. IMPORTANT: Return ONLY the raw HTML, NO markdown code blocks, NO ``` wrappers.",
        "summary": "You are a CEO. You may use business emojis to enhance clarity. Provide a concise executive summary: business intent, user value exchange, trust implications. FORMAT YOUR RESPONSE AS WELL-STRUCTURED HTML with proper headings (<h3>), paragraphs (<p>), and business-style formatting (<strong>, <em>). IMPORTANT: Return ONLY the raw HTML, NO markdown code blocks, NO ``` wrappers.",
        "proscons": "You are a CEO. You may use business emojis to enhance clarity. Analyze from a strategic view: competitive positioning, UX friction, trust signals, business model implications. FORMAT YOUR RESPONSE AS WELL-STRUCTURED HTML with proper headings (<h3>), lists (<ul>), paragraphs (<p>), and business-style formatting (<strong>, <em>). IMPORTANT: Return ONLY the raw HTML, NO markdown code blocks, NO ``` wrappers.",
        "recommendation": "You are a CEO. You may use business emojis to enhance clarity. Give a strategic recommendation on whether users should use this service. FORMAT YOUR RESPONSE AS WELL-STRUCTURED HTML with proper headings (<h3>), paragraphs (<p>), and business-style formatting (<strong>, <em>). IMPORTANT: Return ONLY the raw HTML, NO markdown code blocks, NO ``` wrappers.",
        "alternatives": "You are a CEO. You may use business emojis to enhance clarity. Suggest competitors with stronger value propositions and better trust alignment. FORMAT YOUR RESPONSE AS WELL-STRUCTURED HTML with proper headings (<h3>), lists (<ul>), paragraphs (<p>), and business-style formatting (<strong>, <em>). IMPORTANT: Return ONLY the raw HTML, NO markdown code blocks, NO ``` wrappers.",
        "comprehensive": "You are a CEO conducting a complete strategic business analysis of these Terms & Conditions from multiple perspectives. You may use business emojis to enhance clarity. Provide a comprehensive multi-angle analysis covering: 1) TRUST-DAMAGING CLAUSES: Rank clauses by impact on user trust, considering PR risk, retention, and reputation. 2) EXECUTIVE SUMMARY: Provide concise overview of business intent, user value exchange, and trust implications. 3) STRATEGIC PROS & CONS: Analyze competitive positioning, UX friction, trust signals, and business model implications. 4) STRATEGIC RECOMMENDATION: Give clear recommendation on whether users should use this service from a business strategy perspective. 5) COMPETITIVE ALTERNATIVES: Suggest competitors with stronger value propositions and better trust alignment. FORMAT YOUR RESPONSE AS WELL-STRUCTURED HTML with proper headings (<h2> for main sections, <h3> for subsections), lists (<ul>, <ol>), paragraphs (<p>), and business-style formatting (<strong>, <em>). Use colors to indicate risk levels and make each section visually distinct and professional. IMPORTANT: Return ONLY the raw HTML, NO markdown code blocks, NO ``` wrappers."
    },
    "brainrot": {
...
async function runAnalysis(customPromptText = null) {
    ...
    try {
        ...
        const response = await fetch(`${SERVER_URL}/analyze`, {
            ...
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
                pageText: currentDocument.slice(0, 15000),
